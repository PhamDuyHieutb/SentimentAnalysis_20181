...
def ConvertAllDataToSvm(path_traindata,path_testdata):
    ...
    convertdata(input_train, "preprocess/datatrainsvm")
    convertdata(inputtest, "preprocess/datatestsvm")
...
FOLDER_TRAINDATA_RESTOP = "preprocess/train"
FOLDER_TESTDATA_RESTOP  = "preprocess/test"

# data after filter by dictionary (final)
FOLDER_FINAL_TRAINDATA   = "preprocess/trainprocessed"
FOLDER_FINAL_TESTDATA   = "preprocess/testprocessed"
# path dictionary
PATH_DICT      = "preprocess/dictionary"
